...
'is_supply' => 'bool',
'is_realization' => 'bool',
'promo_code_discount' => 'BigDecimal',
...
'spp' => 'BigDecimal',
'for_pay' => 'BigDecimal',
'finished_price' => 'BigDecimal',
'price_with_disc' => 'BigDecimal',
'nm_id' => 'int',
'subject' => 'string',
'category' => 'string',
'brand' => 'string',
...
'srid' => 'getSrid'    ];
     ...
     * Sets total_price
     *
     * @param BigDecimal $total_price Цена до согласованной скидки/промо/спп. Для получения цены со скидкой можно воспользоваться формулой `priceWithDiscount = totalPrice * (1 - discountPercent/100)`
     *
     * @return $this
     */
     ...
     *
     * @param BigDecimal $promo_code_discount Скидка по промокоду
     *
     * @return $this
     */
     ...
     * Sets spp
     *
     * @param BigDecimal $spp Согласованная скидка постоянного покупателя
     *
     * @return $this
     */
     ...
     * Sets for_pay
     *
     * @param BigDecimal $for_pay К перечислению поставщику
     *
     * @return $this
     */
     ...
     * Sets finished_price
     *
     * @param BigDecimal $finished_price Фактическая цена заказа с учетом всех скидок
     *
     * @return $this
     */
     ...
     *
     * @param BigDecimal $price_with_disc Цена, от которой считается вознаграждение поставщика `forpay` (с учетом всех согласованных скидок)
     *
     * @return $this
     */
