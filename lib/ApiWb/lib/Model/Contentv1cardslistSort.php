...
/**
 * Contentv1cardslistSort Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class Contentv1cardslistSort implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'contentv1cardslist_sort';
...
'ascending' => 'getAscending'    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['search_value'] = isset($data['search_value']) ? $data['search_value'] : null;
     ...
     * Sets search_value
     *
     * @param string $search_value Значение для поиска. Всегда строка. Поиск работает по номенклатурам и артикулам.
     *
     * @return $this
     */
     ...
     * Sets sort_column
     *
     * @param string $sort_column Выбор параметра для сортировки. По умолчанию `updateAt desc` - дата обновления по убыванию. Доступен так же параметр сортировки - `hasPhoto`.
     *
     * @return $this
     */
