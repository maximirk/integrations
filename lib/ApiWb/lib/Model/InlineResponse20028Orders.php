...
/**
 * InlineResponse20028Orders Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class InlineResponse20028Orders implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'inline_response_200_28_orders';
...
'office_latitude' => 'BigDecimal',
'office_longitude' => 'BigDecimal',
...
self::DELIVERY_TYPE_2,        ];
     ...
     *
     * @param BigDecimal $office_latitude Широта адреса ПВЗ/магазина, куда необходимо доставить заказ (если применимо).
     *
     * @return $this
     */
     ...
     *
     * @param BigDecimal $office_longitude Долгота адреса ПВЗ/магазина, куда необходимо доставить заказ (если применимо).
     *
     * @return $this
     */
