...
/**
 * InlineResponse20041Params Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class InlineResponse20041Params implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'inline_response_200_41_params';
    ...
    protected static $swaggerTypes = [
        'intervals' => '\Swagger\Client\Model\InlineResponse20041Intervals[]',
'daily_budget' => 'int',
'price' => 'int',
'menu_id' => '',
'subject_id' => '',
...
'set_id' => 'getSetId'    ];
     ...
     * Gets intervals
     *
     * @return \Swagger\Client\Model\InlineResponse20041Intervals[]
     */
     ...
     * Sets intervals
     *
     * @param \Swagger\Client\Model\InlineResponse20041Intervals[] $intervals Интервалы часов показа РК
     *
     * @return $this
     */
     ...
     * Sets menu_id
     *
     * @param  $menu_id Идентификатор меню, где размещается РК (для РК в каталоге)
     *
     * @return $this
     */
     ...
     * Sets subject_id
     *
     * @param  $subject_id Идентификатор предметной группы, для которой создана РК (для РК в карточке товара, поиске и рекомендациях)
     *
     * @return $this
     */
     ...
     * Sets set_id
     *
     * @param  $set_id Идентификатор сочетания предмета и пола (для РК в карточке товара)
     *
     * @return $this
     */
