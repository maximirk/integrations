...
class InlineResponse20035Orders implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'inline_response_200_35_orders';
...
self::WB_STATUS_CANCELED_BY_CLIENT,        ];
     ...
     *
     * @param string $supplier_status Статус сборочного задания продавца (устанавливается продавцом)
     *
     * @return $this
     */
