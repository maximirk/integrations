 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class Supply implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Supply';
...
'is_large_cargo' => 'getIsLargeCargo'    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['scan_dt'] = isset($data['scan_dt']) ? $data['scan_dt'] : null;
     ...
     * Sets done
     *
     * @param bool $done Флаг закрытия поставки
     *
     * @return $this
     */
     ...
     * Sets created_at
     *
     * @param \DateTime $created_at Дата создания поставки (RFC3339)
     *
     * @return $this
     */
     ...
     * Sets closed_at
     *
     * @param \DateTime $closed_at Дата закрытия поставки (RFC3339)
     *
     * @return $this
     */
     ...
     * Sets scan_dt
     *
     * @param \DateTime $scan_dt Дата скана поставки (RFC3339)
     *
     * @return $this
     */
     ...
     * Sets is_large_cargo
     *
     * @param Bool $is_large_cargo сКГТ-признак поставки
     *
     * @return $this
     */
