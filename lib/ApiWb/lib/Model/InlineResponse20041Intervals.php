...
/**
 * InlineResponse20041Intervals Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class InlineResponse20041Intervals implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'inline_response_200_41_intervals';
...
'end' => 'getEnd'    ];
     ...
     * Sets begin
     *
     * @param int $begin Время начала показов
     *
     * @return $this
     */
     ...
     * Sets end
     *
     * @param int $end Время окончания показов
     *
     * @return $this
     */
