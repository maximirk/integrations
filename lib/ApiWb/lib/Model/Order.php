...
'priority_sc' => 'string[]',
'offices' => 'string[]',
'address' => '\Swagger\Client\Model\OrderAddress',
'user' => '\Swagger\Client\Model\OrderUser',
'skus' => 'string[]',
'price' => 'int',
'converted_price' => 'int',
'currency_code' => 'int',
...
'is_large_cargo' => 'getIsLargeCargo'    ];
    ...
    const DELIVERY_TYPE_DBS = 'dbs';
const DELIVERY_TYPE_FBS = 'fbs';
...
self::DELIVERY_TYPE_FBS,        ];
     ...
     * Sets warehouse_id
     *
     * @param int $warehouse_id Идентификатор склада продавца, на который поступило сборочное задание
     *
     * @return $this
     */
     ...
     * Sets supply_id
     *
     * @param string $supply_id Идентификатор поставки. Возвращается, если заказ закреплён за поставкой
     *
     * @return $this
     */
     ...
     * Sets address
     *
     * @param \Swagger\Client\Model\OrderAddress $address address
     *
     * @return $this
     */
     ...
     * Gets user
     *
     * @return \Swagger\Client\Model\OrderUser
     */
     ...
     * Sets user
     *
     * @param \Swagger\Client\Model\OrderUser $user user
     *
     * @return $this
     */
     ...
     * Sets skus
     *
     * @param string[] $skus Массив баркодов товара
     *
     * @return $this
     */
     ...
     *
     * @param int $converted_price Цена продажи с учетом скидок в копейках, сконвертированная в валюту страны продавца по курсу на момент создания сборочного задания. Предоставляется в информационных целях
     *
     * @return $this
     */
     ...
     * Sets order_uid
     *
     * @param string $order_uid Идентификатор транзакции для группировки сборочных заданий. Сборочные задания в одной корзине покупателя будут иметь одинаковый orderUID
     *
     * @return $this
     */
     ...
     * Sets delivery_type
     *
     * @param string $delivery_type Тип доставки: fbs - доставка на склад Wildberries, dbs - доставка силами продавца
     *
     * @return $this
     */
