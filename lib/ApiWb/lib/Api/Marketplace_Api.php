...
class Marketplace_Api
{
     ...
     *
     * @param  int $warehouse Идентификатор склада продавца (required)
     * @param  \Swagger\Client\Model\StocksWarehouseBody $body body (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     */
    public function apiV3StocksWarehousePut($warehouse, $body = null)
    {
        $this->apiV3StocksWarehousePutWithHttpInfo($warehouse, $body);
    }
     ...
     *
     * @param  int $warehouse Идентификатор склада продавца (required)
     * @param  \Swagger\Client\Model\StocksWarehouseBody $body (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function apiV3StocksWarehousePutWithHttpInfo($warehouse, $body = null)
    {
        $returnType = '';
        $request = $this->apiV3StocksWarehousePutRequest($warehouse, $body);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiV3StocksWarehousePutAsync($warehouse, $body = null)
    {
        return $this->apiV3StocksWarehousePutAsyncWithHttpInfo($warehouse, $body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiV3StocksWarehousePutAsyncWithHttpInfo($warehouse, $body = null)
    {
        $returnType = '';
        $request = $this->apiV3StocksWarehousePutRequest($warehouse, $body);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function apiV3StocksWarehousePutRequest($warehouse, $body = null)
    {
        // verify the required parameter 'warehouse' is set
        if ($warehouse === null || (is_array($warehouse) && count($warehouse) === 0)) {
            throw new \InvalidArgumentException(
