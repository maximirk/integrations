...
class _Api
{
    ...
    /**
     * Operation contentV1CardsListPost
     *
     * Список НМ
     *
     ...
     */
    public function contentV1CardsListPost($body)
    {
        list($response) = $this->contentV1CardsListPostWithHttpInfo($body);
        return $response;
    }

    /**
     * Operation contentV1CardsListPostWithHttpInfo
     *
     * Список НМ
     *
     ...
     */
    public function contentV1CardsListPostWithHttpInfo($body)
    {
        $returnType = '\Swagger\Client\Model\InlineResponse2003';
        $request = $this->contentV1CardsListPostRequest($body);
    ...
    /**
     * Operation contentV1CardsListPostAsync
     *
     * Список НМ
     *
     * @param  \Swagger\Client\Model\Body3 $body (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function contentV1CardsListPostAsync($body)
    {
        return $this->contentV1CardsListPostAsyncWithHttpInfo($body)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation contentV1CardsListPostAsyncWithHttpInfo
     *
     * Список НМ
     *
     * @param  \Swagger\Client\Model\Body3 $body (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function contentV1CardsListPostAsyncWithHttpInfo($body)
    {
        $returnType = '\Swagger\Client\Model\InlineResponse2003';
        $request = $this->contentV1CardsListPostRequest($body);
    ...
    /**
     * Create request for operation 'contentV1CardsListPost'
     *
     * @param  \Swagger\Client\Model\Body3 $body (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function contentV1CardsListPostRequest($body)
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling contentV1CardsListPost'
            );
        }

        $resourcePath = '/content/v1/cards/list';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function contentV1DirectoryTnvedGetRequest($object_name = null, $tnveds_like = null)
    {
        ...
        // query params
        if ($object_name !== null) {
            $queryParams['objectName'] = ObjectSerializer::toQueryValue($object_name);
        }
        // query params
        if ($tnveds_like !== null) {
            $queryParams['tnvedsLike'] = ObjectSerializer::toQueryValue($tnveds_like);
        }
    ...
    protected function publicApiV1UpdateDiscountsPostRequest($body, $activate_from = null)
    {
        ...
        if ($activate_from !== null) {
            $queryParams['activateFrom'] = ObjectSerializer::toQueryValue($activate_from);
        }
